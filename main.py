...
def train(X_train_scaled, X_test_scaled, y_train, y_test, epochs=40):
    # create dataloaders
    ...
    for epoch in range(epochs):
        ...
        # reduce learning rate if mae plateaus
        ...
        print(
            ...
            f"test_mae: {test_accuracy:.4f}{indicator}{RESET}"
        )

    print(f"\n{GREEN}🎉 Training complete! Best test MAE: {best_mae:.4f}{RESET}")
...
def main():
    ...
    # scale features
    print(f"\n{BOLD}{CYAN}Fitting scaler...{RESET}")
